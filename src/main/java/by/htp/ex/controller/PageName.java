...
public final class PageName {
    ...
    public static final String BASELAYOUT_PAGE = "/WEB-INF/pages/layouts/baseLayout.jsp";
    ...
    public static final String REGISTRATION_PAGE = "controller?command=go_to_registration_page";
